...
SELECT DISTINCT maker as "Hãng sản xuất" FROM store_cms_plusplus.laptop ORDER BY maker ASC;

SELECT SUM(sold) as "Doanh số" FROM store_cms_plusplus.laptop;

SELECT SUM(sold * price) as "Doanh thu" FROM store_cms_plusplus.laptop;